...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.loggedIn === true && this.props.musicNum > 0) {
      ...
      console.log("step & music num");
      console.log(this.state.step);
      console.log(this.props.musicNum);
      console.log('home.js utype 1');
      console.log(this.props.utype);
      const payload = { "musicIndex": this.props.mid };
      ...
      return(
        <div className="mainPage">
          <div className="introclass">
            ...
            <p className='hint'>当前实验进度为 {this.props.expNum} / 3， <br /><br />请在4月7日之前完成剩余部分</p>
